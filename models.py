class Controller:
    ...
    def search_history_by_order_id(self, order_id):##############ไม่มีในClass diagram ไม่รู้ว่ายังใช้อยู่มั้ย
...
class Custumer_account(Account):
    ...
    def add_address_list(self,name,house_id,soi,sub_distric,distric,province,post_code,tel):#############
        self.__address_list.append(Address(name,house_id,soi,sub_distric,distric,province,post_code,tel))
        
class Address:#########################เพิ่มใหม่หมด######################################
    def __init__(self,name,house_id,soi,sub_distric,distric,province,post_code,tel):
        self.__name        = name
...
class Cart:
    ...
    def remove_selected_product(self, product_id):#########################################ยังไม่เเน่ใจ
...
class selected_product(Cart):
    ...
    @property
    def get_quanity(self):#######################################ในDiagram เขียนว่า get product ไม่เเน่ใจว่าผิดหรือถูก
        return self.__quanity
...
class Order:
    def __init__(self, order_id,product_list,order_price,payment_type, account, address, tel, status):
